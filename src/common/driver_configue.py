...
class driver_configure():
    def get_driver(self):
        ...
        try:
            ...
            self.desired_caps['appPackage'] = 'com.webank.wemoney'     # APK包名
            self.desired_caps['appActivity'] = 'com.webank.wemoney.EmptyActivity'     # 被测程序启动时的Activity
            ...
            self.desired_caps['deviceName'] = 'TWHAAA7L99999999'     # 手机ID
